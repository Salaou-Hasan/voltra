    ...
    tokio::spawn(async move {
        ...
        if let Some(Ok(Message::Binary(bytes))) = r.next().await {
            ...
            if let ClientMessage::ReducerCall(call) = msg {
                ...
                let resp = voltra_client::types::ReducerResponse {
...
async fn supports_two_frame_subscription_delivery() {
    ...
    tokio::spawn(async move {
        ...
        let route = ServerMessage::SubscriptionRoute(voltra_client::types::SubscriptionRoute {
            subscription_ids: vec![sub_id.clone()],
        });
        let body = ServerMessage::SubscriptionBody(voltra_client::types::SubscriptionBody {
