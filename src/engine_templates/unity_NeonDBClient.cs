...
//
//   var db = new NeonDBClient("ws://127.0.0.1:3000");
//   await db.Connect();
...
namespace NeonDB
{
    ...
    public sealed class NeonDBClient : IDisposable
    {
        ...
        /// Queue drained by NeonDBBehaviour.Update() so callbacks run on the
        ...
        public NeonDBClient(string url, string apiKey = null)
        {
            _url = url;
            _apiKey = apiKey;
        }
