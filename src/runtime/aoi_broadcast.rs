...
impl AoiBroadcaster {
    ...
    pub fn register_client(
        ...
        self.clients
            .insert(client_id, AoiClient { tx, player_entity });
    }
    ...
    fn compute_deltas(
        &self,
        current: &HashMap<EntityId, (f32, f32)>,
        tick_number: u64,
    ) -> Vec<AoiDelta> {
...
mod tests {
    ...
    fn make_channel() -> (
        Sender<OutboundFrames>,
        tokio::sync::mpsc::Receiver<OutboundFrames>,
    ) {
